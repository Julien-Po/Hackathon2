 ...
 */
final class Version20220329153801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD author_id INT DEFAULT NULL, DROP author');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD author VARCHAR(255) DEFAULT NULL, DROP author_id');
    }
}
